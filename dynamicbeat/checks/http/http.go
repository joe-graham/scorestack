...
type Definition struct {
	...
	Timeout              string             `optiontype:"optional" optiondefault:"10"` // Time in seconds for the HTTP request to timeout
}
...
func (d *Definition) Run(ctx context.Context) schema.CheckResult {
	...
	// Convert timeout str to int if detected
	// if strings.Compare(d.Timeout, "<no value>") != 0 {
	// 	timeout, _ = strconv.ParseInt(d.Timeout, 10, 0)
	// }
